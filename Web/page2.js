...
{			
			...
			if(starttime && stoptime)
			{
				...
				cell1.innerHTML="Conductor<input type='radio' name='extra' value='1' id='conductor' />";
				cell2.innerHTML="Positive Train Control<input type='radio' name='extra' value='2' id='train_c' />";
				cell3.innerHTML="Cruise Control<input type='radio' name='extra' value='3' id='cruise_control' />";
				cell4.innerHTML="Other<input type='radio' name='extra' value='4' id='other'>";
