...
#  define ELPP_FUNC __FUNCTION__            // bv changed __FUNCSIG__
#elif ELPP_COMPILER_GCC  // GCC
#  define ELPP_FUNC __FUNCTION__            // bv changed __PRETTY_FUNCTION__
...
#  if ELPP_OS_UNIX
#      if ELPP_OS_ANDROID
static const char* kDefaultLogFile                         =      "log/shado-%datetime{%M-%d-%H.%m}.log";//"log/mylog.log";
#      else
static const char* kDefaultLogFile                         =      "log/shado-%datetime{%M-%d-%H.%m}.log";//"log/mylog.log";
#      endif  // ELPP_OS_ANDROID
#  elif ELPP_OS_WINDOWS
