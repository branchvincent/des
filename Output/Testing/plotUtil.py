...
#inFile = sys.argv[1]
#outFile1 = '/Users/Branch/Desktop/DES/DES/Output/Testing/engGraph.pdf'
...
#	Set input and output files
	...
	if isEng:
		inFile = '/Users/Branch/Desktop/DES/DES/Output/Testing/eng.csv'
		outFile = '/Users/Branch/Desktop/DES/DES/Output/Testing/engGraph.pdf'
	else:
		inFile = '/Users/Branch/Desktop/DES/DES/Output/Testing/cond.csv'
		outFile = '/Users/Branch/Desktop/DES/DES/Output/Testing/conGraph.pdf'
...
#	Read csv file, depending on number of runs
	...
	if oneRun:										# For one run,
		...
		for row in reader:
			...
			time.append(float(row[0]))				# Add time interval
			data[0].append(float(row[-2]))			# Add avg utilization
			error.append(float(row[-1]))			# Add std dev
			numRuns = len(row) - 3					# Update number of runs
